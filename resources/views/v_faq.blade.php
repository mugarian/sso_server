                    ...
                    <div class="accordion text-black" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    dibangun untuk memudahkan Civitas Akademika Polsub dalam mengakses semua Sistem Polsub
                                    hanya
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                data-parent="#accordionExample">
                                <div class="card-body">
                                    Dengan cara menghubungi Admin UPT TIK untuk mendaftarkan sistem (client) ke Sistem SSO
                                    Polsub
                                    untuk diberikan <code>ID Client</code> dan <code>Secret Code Client</code> sebagai
                                    syarat untuk
