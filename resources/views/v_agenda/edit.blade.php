                ...
                <div class="form-group">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                            name="title" value="{{ old('title', $agenda->title) }}" required placeholder="Nama">
                        @error('title')
                    ...
                    <div class="mb-2">
                        ...
                        <input type="datetime-local" class="form-control @error('end') is-invalid @enderror" id="end"
                            name="end" value="{{ old('end', $agenda->end) }}" required>
                        @error('end')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location"
                            name="location" value="{{ old('location', $agenda->location) }}" required placeholder="Lokasi">
                        @error('location')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3"
                            name="description" placeholder="Deskripsi">{{ old('description', $agenda->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="color" class="form-control @error('backgroundColor') is-invalid @enderror"
                            ...
                            value="{{ old('backgroundColor', $agenda->backgroundColor) }}" required placeholder="#ff0000">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="color" class="form-control @error('borderColor') is-invalid @enderror"
                            id="borderColor" name="borderColor" value="{{ old('borderColor', $agenda->borderColor) }}"
                            required placeholder="#ffffff">
                        @error('borderColor')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="color" class="form-control @error('textColor') is-invalid @enderror" id="textColor"
                            name="textColor" value="{{ old('textColor', $agenda->textColor) }}" required
                            placeholder="#000000">
                        @error('textColor')
                            <div class="invalid-feedback">
                                {{ $message }}
