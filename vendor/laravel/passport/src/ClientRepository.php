...
class ClientRepository
{
     ...
     * @return \Laravel\Passport\Client
     */
    public function create($userId, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect, $provider = null, $personalAccess = false, $password = false, $confidential = true)
    {
     ...
     * @return \Laravel\Passport\Client
     */
    public function createPersonalAccessClient($userId, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect)
    {
        return tap($this->create($userId, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect, null, true), function ($client) {
     ...
     * @return \Laravel\Passport\Client
     */
    public function createPasswordGrantClient($userId, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect, $provider = null)
    {
        return $this->create($userId, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect, $provider, false, true);
    }
     ...
     * @return \Laravel\Passport\Client
     */
    public function update(Client $client, $name, $logo, $login, $dosen, $mahasiswa, $staff, $redirect)
    {
        $client->forceFill([
            'name' => $name,
            'logo' => $logo,
