            ...
            <form action="{{ route('news.update', ['news' => $berita->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="mb-2">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $berita->cover }}">
                        @if ($berita->cover)
                            <img src="{{ asset('/storage/' . $berita->cover) }}" alt="berita-avatar"
                                class="d-block rounded img-preview" width="250" id="avatar" />
                        @else
                            <img src="{{ asset('img') }}/unknown.png" alt="berita-avatar"
                                class="d-block rounded img-preview" width="250" id="avatar" />
                        @endif
                        <br>
                    ...
                    <div class="mb-2">
                        <label for="title" class="col-form-label">Judul Berita:</label>
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                            name="title" value="{{ old('title', $berita->title) }}" required placeholder="Nomor Induk"
                            min="1">
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="editor" name="description">{{ old('description', $berita->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
