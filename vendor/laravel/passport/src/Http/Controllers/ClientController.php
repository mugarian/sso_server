...
class ClientController
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validation->make($request->all(), [
            ...
            'logo' => 'required|image|mimes:jpg,jpeg,png|max:8000',
            'login' => 'required',
            'dosen' => 'required',
            'mahasiswa' => 'required',
            'staff' => 'required',
        ...
        if ($request->file('logo')) {
            $validated['logo'] = $request->file('logo')->store('client-images');
        }
        ...
        return redirect('/dashboard/klien')->with('success', 'Tambah Data Client Berhasil');
    }
    ...
    public function update(Request $request, $clientId)
    {
        ...
        $this->validation->make($request->all(), [
            'name' => 'required|max:191',
            'logo' => 'nullable|image|mimes:jpg,jpeg,png|max:8000',
            'login' => 'required',
            'dosen' => 'required',
            'mahasiswa' => 'required',
            'staff' => 'required',
        ...
        if ($request->file('logo')) {
            ...
            $validate['logo'] = $request->file('logo')->store('client-images');
        } else {
            $validate['logo'] = $request->oldLogo;
        }
        ...
        return redirect('/dashboard/klien')->with('success', 'Ubah Data Client Berhasil');
    }
