                        ...
                        @if (!auth()->user()->isVerified)
                            @if (auth()->user()->role != 'admin')
                                <div class="alert alert-warning text-center" role="alert">
                                    Anda Terdaftar Sebagai Tamu atau Belum Terverikasi. Silahkan Ajukan ke bagian UPT TIK
                                    untuk
                                    menjadikan akun anda
                                    sebagai bagian dari Civitas Akademika Politeknik Negeri Subang
                                </div>
                            @endif
                        @endif
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 border rounded text-center pt-3 bg-light">
                            <a href="/profile" class="text-decoration-none">
                                <img src="{{ asset('img') }}/profile.png" alt="client-avatar" height="100"
                                    width="100" />
                            </a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 border rounded text-center p-0 bg-light">
                            <button type="button" class="btn btn-light pt-3" data-toggle="modal"
                                data-target="#exampleModal">
                                <img src="{{ asset('img') }}/logout.png" alt="client-avatar" height="100"
                                    width="100" />
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-dark" id="exampleModalLabel">Konfirmasi Logout?
                                            </h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            @if (auth()->user()->isMicrosoftAccount)
                                                <a href="{{ route('mslogout') }}" class="btn btn-primary">Logout
                                                    Microsoft</a>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                data-target="#berita" title="Kelola Berita">
                                <i class="fas fa-fw fa-cog"></i>
                            </button>
                            <div class="modal fade" id="berita" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Pengaturan Rekomendasi
                                                Berita</h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('news.storeapi') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <div class="mb-2">
                                                        <label for="query" class="col-form-label">Kata
                                                            Kunci:</label>
                                                        <small>(Boleh Dikosongkan)</small>
                                                        <input type="text"
                                                            class="form-control @error('query') is-invalid @enderror"
                                                            id="query" name="query"
                                                            value="{{ old('query', $news->query) }}"
                                                            placeholder="Kata Kunci" min="1">
                                                        @error('query')
                                                    ...
                                                    <div class="mb-2">
                                                        <label for="page_size" class="col-form-label">Jumlah
                                                            news:</label>
                            ...
                            @foreach ($all_news as $news)
                                <div class="card-deck mr-1 my-3">
                                    <a href="{{ $news->url ?? '/' }}" class="text-dark text-decoration-none">
                                        <div class="card">
                                            <img src="{{ $news->urlToImage ?? asset('img/news.jpg') }}"
